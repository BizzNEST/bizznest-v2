export const brownIssuesCaseStudy = {
  date: 'Spring 2025',
  client: 'Brown Issues',
  tools: ['Figma', 'WordPress'],
  siteUrl: 'https://brownissuestv.org/',
  ...
  problem: {
    subtitle:
      'Brown Issues wanted to increase engagement on their website, especially from youth looking to get involved and funders considering support.',
    description:
      "However, when we reviewed the site, there was a lot of information, but it wasn't easy to find. Navigation was confusing, content was dense, and key actions were buried. For an organization with two very different audiences, that friction was getting in the way.",
  },

  goalsAndObjectives: {
    content: [
      'At the start of the project, the team aligned on five goals that shaped every design decision:',
      '- Clarify the information architecture so users can navigate the website without guessing',
      '- Reduce cognitive load by consolidating long text blocks',
      '- Strengthen calls to action with clear, direct labels that guide the user to next steps',
      '- Support their two audiences of youth seeking involvement and funders evaluating impact',
      '- Refresh the visual design while keeping the brand identity users already connected with',
    ],
  },

  research: {
    content: [
      'Before making any decisions, we wanted to understand what users were actually struggling with. We focused on three questions:',
      '- Who are our users, and what brings them to the site?',
  ...
  ourSolution: {
    paragraphs: [
      'Our solution was to create a modern, accessible experience that helps users reach what they need faster and with less friction.',
