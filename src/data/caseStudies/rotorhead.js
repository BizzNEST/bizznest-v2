export const rotorheadCaseStudy = {
  date: 'August 2025',
  client: 'Rotorhead',
  tools: ['Figma', 'Adobe Creative Cloud', 'WordPress', 'Asana'],
  ...
  problem: {
    ...
    description:
      'When we started the website design, our team had to begin with limited information about the client and their services. The limited information provided about the business and its services made it challenging to determine site structure, messaging, and overall design direction.',
  },

  goalsAndObjectives: {
    intro: 'At the start of the project, the team aligned on a set of guiding goals to inform every decision:',
    items: [
      'Communicate the brand clearly by presenting Rotorhead as a strategic consultancy offering leadership development, team building, and storytelling workshops for startups and corporate clients.',
      'Balance professionalism with playfulness to reflect the brand\'s mission of creating collaborative environments that encourage creativity, joy, and open idea sharing.',
      'Simplify navigation and user flow so visitors can easily understand services, find key information, and take the next step toward booking workshops.',
      'Create a scalable design system with clear visual hierarchy, modern visuals, and consistent components that support future growth and content expansion.',
  ...
  research: {
    content: [
      'Before beginning the design process, our team focused on understanding the client\'s business, services, and vision for the website.',
      'To guide the redesign, we focused on answering three core questions:',
  ...
  researchMethods: {
    description:
      'Our research process combined stakeholder interviews, competitive analysis, and a review of comparable consultancy websites to better understand user expectations and industry standards.',
    images: [],
  },
  ...
  ourSolution: {
    paragraphs: [
      'Create a modern, accessible experience that helps users reach programs and resources more quickly.',
